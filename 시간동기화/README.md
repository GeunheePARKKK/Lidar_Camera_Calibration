...
2. **Line1 노출 카운터 채널** — 어느 카메라를 꽂아도 채널 2(GPIO15)가 셉니다 (`CNT,200,0,396,0,0`). 카메라 S/N이 아니라 **커넥터 위치** 문제로 보입니다. 트리거 수의 약 1.9배를 세는 채터링도 있습니다. 촬영에는 영향이 없고, 트리거 번호 ↔ FrameID 대응을 확정하는 검산만 막힙니다.
